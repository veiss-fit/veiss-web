...
function DescriptiveTabs() {
  ...
  return (
    <div id="about-us" className="w-full min-h-screen relative bg-[#F2F2F2]">
      <PageWrapper>
        <div className="relative z-20 xl:px-[205px] lg:px-[80px] pt-[90px] lg:pt-[195px] pb-[120px] lg:pb-[100px] flex flex-col lg:flex-row justify-between gap-[40px]">
          {/* Tabs */}
          ...
          {/* Content */}
          <div className="relative text-secondary tracking-[0.5px] text-[14px] sm:text-[16px] leading-[24px] 
          sm:leading-[29px] w-full max-w-[600px] mx-auto lg:mx-0 px-4 sm:px-6 text-center">
            {/* Tab 0 */}
            <div className={`${selectedTab === 0 ? "block" : "hidden"} transition-opacity duration-300 ease-in-out text-center lg:text-left flex flex-col gap-[22px]`}>
            ...
            {/* Tab 1 */}
            <div className={`${selectedTab === 1 ? "block" : "hidden"} transition-opacity duration-300 ease-in-out text-center lg:text-left flex flex-col gap-[22px]`}>
              <h6 className="font-semibold text-[16px] md:text-[20px] lg:text-[24px]">
                What we do
              </h6>
              <p>
              ...
              <p>
                By eliminating the need for manual input, we make it easier for gym-goers to focus on 
                their workouts and stay committed to their fitness objectives. Our accompanying app 
                subscription unlocks advanced analytics and personalized progress tracking.
              </p>
            </div>

            {/* Tab 2 */}
            <div className={`${selectedTab === 2 ? "block" : "hidden"} transition-opacity duration-300 ease-in-out text-center lg:text-left flex flex-col gap-[22px]`}>
              <h6 className="font-semibold text-[16px] md:text-[20px] lg:text-[24px]">
                Our Approach
              </h6>
              <p>
              ...
              <ol className="list-disc list-inside pl-5 space-y-2 text-center mx-auto w-fit sm:text-left">
                <li>Effortless Tracking: No manual input—just automatic, error-free logging.</li>
                <li>Real-Time Insights: Instant feedback keeps workouts optimized and engaging.</li>
                <li>User-Centric Design: Built for ease, motivation, and consistency.</li>
